...
**📺 วิดีโอสาธิตการใช้งานระบบ: https://youtu.be/qfaXlMMQD1U**
...
ต้องเปิด [Docker Desktop](https://www.docker.com/) ไว้ก่อน (ใช้กับการรันทั้ง 2 แบบด้านล่าง)
...
- รายชื่อธนาคาร 20 แห่ง (ธนาคารพาณิชย์ + ธนาคารเฉพาะกิจของรัฐ) สำหรับ dropdown เลือกธนาคารในฟอร์ม
...
- **หน้ายื่นคำขอทุน (สาธารณะ)** — นักศึกษายื่นคำขอได้โดยไม่ต้องเข้าสู่ระบบ เลือกประเภททุนและธนาคาร
  จาก dropdown ที่ดึงข้อมูลจากฐานข้อมูลจริง พร้อม validation ทั้ง client-side และ server-side
  และต้องให้ความยินยอม PDPA ก่อนบันทึก
...
- **จัดการสถานะคำขอ** (รอพิจารณา → อนุมัติ / ไม่อนุมัติ) พร้อมบันทึกหมายเหตุประกอบ จากแผงสถานะ
  ในหน้าดูรายละเอียดคำขอ
