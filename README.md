...
- หน้ายื่นคำขอทุน (นักศึกษา): http://localhost:8080/request
...
> โดยเฉพาะ (แยกจากฐานข้อมูลที่ผู้พัฒนาใช้พัฒนาระบบจริง) จึงไม่จำเป็นต้องตั้งค่า `.env` ใด ๆ
> ก่อนรัน `docker compose up`
...
4. เปิดเบราว์เซอร์ไปที่ http://localhost:5173/request (หน้านักศึกษา)
